        ...
        <form className="col s12" onSubmit={this.editPlayer.bind(this)}>
          ...
          <div className="row">
              <div className="input-field col s6">
                <input placeholder="Name" ref="name" type="text" className="validate" defaultValue={currentPlayer.name}></input>
              </div>
              <div className="input-field col s6">
                <input placeholder="Team" ref="team" type="text" className="validate" defaultValue={currentPlayer.team}></input>
              </div>
          </div>
          <div className="row">
              <div className="input-field col s6">
          ...
          <div className="row">
              ...
              <div className="input-field col s6">
                ...
                <select className="browser-default" ref="blockingAblilities" defaultValue={currentPlayer.blockingAblilities}>
                  <option value="0">0 - Hasn't demonstrated skills</option>
                  <option value="1">1 - Needs improvement</option>
                  <option value="2">2 - Skill acquired</option>
                  <option value="3">3 - Great skills/could teach</option>
          ...
          <div className="row">
              <div className="input-field col s6">
                <textarea placeholder="Notes" ref="notes" type="text" className="materialize-textarea" defaultValue={currentPlayer.notes}></textarea>
              </div>
              <div className="input-field col s6">
