...
export default class TeamStats extends Component {
  ...
  render() {
    ...
    const blockingAblilities = Math.round((players.reduce((blockingAblilities, player) => {
      return blockingAblilities + player.blockingAblilities;
    }, 0) / (3 * numPlayers )) * 100 );
      ...
      datasets: [
        {
          ...
          data: [ballManipulation, kickingAbilities, passingAbilities, duelTackling, fieldCoverage,
            blockingAblilities, gameStrategy, playmakingRisks]
        }
      ]
    };
    return (
